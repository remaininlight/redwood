...
type Tx struct {
	ID         redwood_dev_types.ID        `protobuf:"bytes,1,opt,name=id,proto3,customtype=redwood.dev/types.ID" json:"id"`
	Parents    []redwood_dev_types.ID      `protobuf:"bytes,2,rep,name=parents,proto3,customtype=redwood.dev/types.ID" json:"parents"`
	Children   []redwood_dev_types.ID      `protobuf:"bytes,3,rep,name=children,proto3,customtype=redwood.dev/types.ID" json:"children"`
...
var fileDescriptor_0fd2153dc07d3b5c = []byte{
	...
	,
}
...
func NewPopulatedTx(r randyTx, easy bool) *Tx {
	this := &Tx{}
	v1 := redwood_dev_types.NewPopulatedID(r)
	this.ID = *v1
	v2 := r.Intn(10)
	this.Parents = make([]redwood_dev_types.ID, v2)
	for i := 0; i < v2; i++ {
		v3 := redwood_dev_types.NewPopulatedID(r)
		this.Parents[i] = *v3
	}
	v4 := r.Intn(10)
	this.Children = make([]redwood_dev_types.ID, v4)
	for i := 0; i < v4; i++ {
		v5 := redwood_dev_types.NewPopulatedID(r)
		this.Children[i] = *v5
	}
