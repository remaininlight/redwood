...
// OnIncomingSessionApproval provides a mock function with given fields: handler
func (_m *HushTransport) OnIncomingSessionApproval(handler func(context.Context, pb.SessionApproval, protohush.HushPeerConn)) {
	_m.Called(handler)
}

// OnIncomingSessionProposal provides a mock function with given fields: handler
func (_m *HushTransport) OnIncomingSessionProposal(handler func(context.Context, []byte, protohush.HushPeerConn)) {
	_m.Called(handler)
}
