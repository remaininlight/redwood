...
// EnqueueForEncryption provides a mock function with given fields: sessionID, plaintext
func (_m *HushProtocol) EnqueueForEncryption(sessionID pb.SessionID, plaintext []byte) error {
	ret := _m.Called(sessionID, plaintext)

	var r0 error
	if rf, ok := ret.Get(0).(func(pb.SessionID, []byte) error); ok {
		r0 = rf(sessionID, plaintext)
	} else {
		r0 = ret.Error(0)
	}
...
// OnMessageDecrypted provides a mock function with given fields: sessionType, handler
func (_m *HushProtocol) OnMessageDecrypted(sessionType string, handler func(pb.SessionID, pb.MultipartyMessage)) {
	_m.Called(sessionType, handler)
}

// OnMessageEncrypted provides a mock function with given fields: sessionType, handler
func (_m *HushProtocol) OnMessageEncrypted(sessionType string, handler func(pb.SessionID, pb.MultipartyMessage)) {
	_m.Called(sessionType, handler)
}
...
// ProposeSession provides a mock function with given fields: ctx, recipients, sessionType, name, epoch
func (_m *HushProtocol) ProposeSession(ctx context.Context, recipients []types.Address, sessionType string, name string, epoch uint64) error {
	ret := _m.Called(ctx, recipients, sessionType, name, epoch)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, []types.Address, string, string, uint64) error); ok {
		r0 = rf(ctx, recipients, sessionType, name, epoch)
	} else {
		r0 = ret.Error(0)
	}
