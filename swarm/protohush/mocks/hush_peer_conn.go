...
// ApproveSession provides a mock function with given fields: ctx, approval
func (_m *HushPeerConn) ApproveSession(ctx context.Context, approval pb.SessionApproval) error {
	ret := _m.Called(ctx, approval)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, pb.SessionApproval) error); ok {
		r0 = rf(ctx, approval)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *HushPeerConn) DeviceSpecificID() string {
	ret := _m.Called()
...
// ProposeSession provides a mock function with given fields: ctx, encryptedProposal
func (_m *HushPeerConn) ProposeSession(ctx context.Context, encryptedProposal []byte) error {
...
func (_m *HushPeerConn) StateURIs() utils.StringSet {
	ret := _m.Called()
